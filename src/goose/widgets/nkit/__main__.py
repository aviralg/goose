...
class NeuroKitWidget(NetworkViewer) :
    ...
    def __init__(self, instance, signals = None, parent = None):
        self.instance = instance
        self.moose    = instance["moose"]
        self.signals  = signals
        self.model    = instance["model"]
        self._setup_menus()
        (network, neurons, compartments, voxels, spines) = self.read_network(path = self.model.path)
    ...
    def _setup_menus(self):
        ...
        self.chemical_compartment_menu.addAction("Show Chemical Signaling")
